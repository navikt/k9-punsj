...
@RestController
@Tag(name = "Omsorgspenger alene om omsorg søknad", description = "Håndtering av søknader av typen Omsorgspenger alene om omsorgen")
internal class OmsorgspengerAleneOmsorgOpenApi {
    @GetMapping(OmsorgspengerAleneOmsorgRoutes.Urls.HenteMappe, produces = ["application/json"])
    @Operation(
        ...
        value = [
            ApiResponse(
                ...
                content = [
                    Content(
                        schema = Schema(
                            implementation = OmsorgspengerAleneOmsorgSøknadDto::class
                        )
                    )
                ]
            )
    ...
    @PostMapping(
        OmsorgspengerAleneOmsorgRoutes.Urls.NySøknad,
    ...
    @GetMapping(OmsorgspengerAleneOmsorgRoutes.Urls.HenteSøknad, produces = ["application/json"])
    @Operation(
        ...
        value = [
            ApiResponse(
                ...
                content = [
                    Content(
                        schema = Schema(
                            implementation = SvarOmsAODto::class
                        )
                    )
                ]
            ),
    ...
    @PutMapping(
        OmsorgspengerAleneOmsorgRoutes.Urls.OppdaterEksisterendeSøknad,
        consumes = ["application/json"],
        produces = ["application/json"]
    )
    @Operation(
    ...
    fun OppdatereSøknad(
        @RequestBody søknad: OmsorgspengerAleneOmsorgSøknadDto
    ) {
    }

    @PostMapping(
        OmsorgspengerAleneOmsorgRoutes.Urls.SendEksisterendeSøknad,
        consumes = ["application/json"],
        produces = ["application/json"]
    )
    @Operation(
    ...
    @PostMapping(
        OmsorgspengerAleneOmsorgRoutes.Urls.ValiderSøknad,
        consumes = ["application/json"],
        produces = ["application/json"]
    )
    @Operation(
